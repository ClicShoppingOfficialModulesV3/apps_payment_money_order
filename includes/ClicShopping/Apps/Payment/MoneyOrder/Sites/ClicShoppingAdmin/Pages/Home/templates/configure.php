  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card card-block headerCard">
        <div class="row">
          <span class="col-md-1 logoHeading"><?php echo HTML::image($CLICSHOPPING_Template->getImageDirectory() . '/categories/modules_modules_checkout_payment.gif', $CLICSHOPPING_MoneyOrder->getDef('heading_title'), '40', '40'); ?></span>
          <span class="col-md-4 pageHeading"><?php echo '&nbsp;' . $CLICSHOPPING_MoneyOrder->getDef('heading_title'); ?></span>
          <span class="col-md-7 text-md-right"><?php echo HTML::button($CLICSHOPPING_MoneyOrder->getDef('button_sort_order'), null, CLICSHOPPING::link('CLICSHOPPING::link(null, 'A&Configuration\Modules&Modules&set=payment'),  'primary'); ?>
        </div>
      </div>
    </div>
  </div>
...
?>
  <form name="Configure" action="<?php echo $CLICSHOPPING_MoneyOrder->link('Configure&Process&module=' . $current_module); ?>" method="post">
...
?>
     <div class="col-md-12 mainTitle"><strong><?php echo $CLICSHOPPING_MoneyOrder->getConfigModuleInfo($current_module, 'title'); ?></strong></div>
      <div class="adminformTitle">
        <div class="row">
          <div class="separator"></div>
           <div class="col-md-12">
